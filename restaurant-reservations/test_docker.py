...
def test_imports():
    ...
    try:
        ...
        from reservations.tasks import send_confirmation_email  # noqa: F401

        print("✅ Tasks de Celery importadas")

        from restaurants.services import TableReservationLock  # noqa: F401
...
def main():
    ...
    if passed == len(tests):
        print(
            "🎉 Todos los tests pasaron! El contenedor está funcionando correctamente"
        )
        return 0
    else:
