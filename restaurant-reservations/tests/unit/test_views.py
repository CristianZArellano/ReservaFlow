...
class ReservationViewSetTest(BaseAPITestCase):
    ...
    def test_list_reservations(self):
        ...
        reservation2 = ConfirmedReservationFactory(restaurant=self.restaurant)
    ...
    def test_create_reservation_success(self, mock_availability, mock_lock):
    ...
    @patch('reservations.views.TableReservationLock')
    @patch('reservations.views.check_table_availability')
    def test_create_reservation_validation_error(self, mock_availability, mock_lock):
...
class ReservationAPIIntegrationTest(BaseAPITestCase):
    ...
    @patch('reservations.views.TableReservationLock')
    @patch('reservations.views.check_table_availability')
    def test_concurrent_reservation_creation(self, mock_availability, mock_lock):
    ...
    def test_reservation_lifecycle_via_api(self):
        ...
        # Create reservation
        with patch('reservations.views.TableReservationLock') as mock_lock, \
             patch('reservations.views.check_table_availability') as mock_avail:
