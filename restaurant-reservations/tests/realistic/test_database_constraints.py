...
class DatabaseConstraintRealisticTest(TransactionTestCase):
    ...
    def test_concurrent_database_writes(self):
        ...
        constraint_errors = [e for e in errors if 'unique_active_reservation' in e.lower()]
        self.assertGreater(
    ...
    def test_foreign_key_constraints(self):
        ...
        print(f"❌ Eliminación de mesa bloqueada correctamente: {type(cm.exception).__name__}")
