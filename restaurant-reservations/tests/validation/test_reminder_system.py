...
def test_reminder_system():
    ...
    try:
        ...
        table = Table.objects.create(restaurant=restaurant, number="1", capacity=4)
        ...
        try:
            result = schedule_reminder(
                str(reservation.id), hours_before=1
            )  # 1 hora antes para testing
        ...
        try:
            ...
            print(
                f"⚠️ Error enviando recordatorio (normal si no hay email configurado): {str(e)}"
            )
